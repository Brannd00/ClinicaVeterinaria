...
import com.mycompany.clinicaveterinaria.Vista.Vista;
...
public class Controlador {
    ...
    private void crearDatosDePrueba() {
        ...
        Mascota m2 = new Mascota("Michi", "Gato", 2, "Negro", "Comun Europeo", "CHIP002", p1);
        ...
        Medicamento med1 = new Medicamento("Amoxicilina", "250mg cada 12h", "Antibiotico", 15000);
