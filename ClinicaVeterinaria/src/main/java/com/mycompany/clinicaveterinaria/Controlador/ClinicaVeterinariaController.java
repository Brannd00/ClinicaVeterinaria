...
public class ClinicaVeterinariaController {
    ...
    private void crearDatosDePrueba() {
        Propietario p1 = new Propietario("Carlos Gómez", "1001234567", "3001112233");
        Mascota m1 = new Mascota("Rocky", "Perro", 3, "Café", "Labrador", "CHIP001", p1);
        Mascota m2 = new Mascota("Michi", "Gato", 2, "Negro", "Común Europeo", "CHIP002", p1);
        p1.agregarMascota(m1);
        p1.agregarMascota(m2);

        Propietario p2 = new Propietario("Laura Pérez", "1009876543", "3009998877");
        ...
        Veterinario v1 = new Veterinario("Dra. Ana Ríos", "LIC-001", "Medicina General");
        Veterinario v2 = new Veterinario("Dr. Luis Torres", "LIC-002", "Cirugía");
        veterinarios.add(v1);
        veterinarios.add(v2);

        Medicamento med1 = new Medicamento("Amoxicilina", "250mg cada 12h", "Antibiótico", 15000);
        ...
        Consulta c2 = new Consulta(2, "2025-06-02", "Vacunación y desparasitación", m3, v2);
        Consulta c3 = new Consulta(3, "2025-06-03", "Revisión por vómito", m2, v1);
